...
class Accert:
    ...
    def extract_total_cost_on_name(self, c,tc_id):
        ...
        # Stored procedure
        # DELIMITER $$
        # CREATE DEFINER=`mnyberg`@`localhost` PROCEDURE `extract_total_cost_on_name`(IN tc_id VARCHAR(50),
    ...
    def update_cost_element_on_name(self, c, ce_name, alg_value):
        ...
        # DELIMITER $$
        # CREATE DEFINER=`mnyberg`@`localhost` PROCEDURE `update_cost_element_on_name`(
        #     IN table_name VARCHAR(50),
